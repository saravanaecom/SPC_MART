        ...
        <>
                ...
                <Box elevation={3} sx={{
                    ...
                    <Typography variant="h4" fontWeight={700} gutterBottom>
                        Welcome to <span style={{ color: "#1976d2" }}>SPC</span>!
                    </Typography>
                    <Typography variant="body1" fontSize={18} lineHeight={1.6}>
                        By accessing or using our website at{" "}
                        <a href="https://www..com/" target="_blank" rel="noopener noreferrer" style={{ color: "#1976d2", textDecoration: "none" }}>
